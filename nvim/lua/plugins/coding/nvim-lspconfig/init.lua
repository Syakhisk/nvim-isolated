...
return {
  {
    ...
    config = function(_, opts)
      ...
      if have_mason then
        mlsp.setup({
          ensure_installed = vim.tbl_deep_extend("force", ensure_installed, Lib.plugins.opts("mason-lspconfig.nvim").ensure_installed or {}),
          handlers = { setup },
        })
      end

      if Lib.lsp.is_enabled("denols") and Lib.lsp.is_enabled("vtsls") then
        local is_deno = require("lspconfig.util").root_pattern("deno.json", "deno.jsonc")
        Lib.lsp.disable("vtsls", is_deno)
        Lib.lsp.disable("denols", function(root_dir, config)
